...
package com.guyuuan.mpv_kmp.bridge
...
@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvInitialize")
fun mpvInitialize(env: COpaquePointer?, clazz: COpaquePointer?): UByte =
    mpv_bridge_initialize(env, clazz)

@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvAttachSurface")
...
@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvDetachSurface")
fun mpvDetachSurface(env: COpaquePointer?, clazz: COpaquePointer?) =
    mpv_bridge_detach_surface(env, clazz)

@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvCommandString")
...
@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvSetProperty")
fun mpvSetProperty(
    env: COpaquePointer?,
    clazz: COpaquePointer?,
    name: COpaquePointer?,
...
@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvGetProperty")
fun mpvGetProperty(
    env: COpaquePointer?,
    clazz: COpaquePointer?,
    name: COpaquePointer?,
...
@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvObserveProperty")
...
@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvUnobserveProperty")
...
@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvWaitEvent")
fun mpvWaitEvent(
    env: COpaquePointer?,
    clazz: COpaquePointer?,
    timeout: Double,
...
@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvWakeup")
fun mpvWakeup(env: COpaquePointer?, clazz: COpaquePointer?) =
    mpv_bridge_wakeup(env, clazz)

@CName("Java_com_guyuuan_mpv_1kmp_MpvNative_mpvTerminate")
